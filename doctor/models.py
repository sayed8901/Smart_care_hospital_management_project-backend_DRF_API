...
class Review(models.Model):
    reviewer = models.ForeignKey(Patient, related_name='Reviewer', on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"Patient: '{self.reviewer.user.first_name}' provides review for Doctor: '{self.doctor.user.first_name}'"
